...
class Main extends JFrame
{
	...
	private static final String basePath = "C:/Users/ATUL/Desktop/signature";

	/*
	 * The constructor, which creates the GUI and start the image processing
	 * task.
	 */
	public Main(File reference) throws IOException
	{
		// Create the GUI
	 ...
	 * the
	 * average as an instance of Color. The point coordinates are proportional
	 * to
	 * the image.
	 */
	 ...
	 * and
	 * the reference one. The signatures for the image passed as the parameter
	 * are
	...
	public static void main(String[] args) throws IOException
	{
		...
		// System.load("C:/Users/ATUL/Downloads/mlib_jai.dll");
		// We have an image!
